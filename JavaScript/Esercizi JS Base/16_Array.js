...
const ArrayStringhe = ["ciao", "come", "va", "oggi", "mi", "sento", "bene"];
const elementSearch = "oggi";

const indiceTrovato = ArrayStringhe.indexOf(elementSearch);
console.log("Indice trovato : " + indiceTrovato);

/*Esercizio 8
Scrivi un programma che prenda un array e inverta l'ordine degli elementi.*/

console.log(ArrayStringhe.reverse());
...
for (let stringa of ArrayStringhe) {
  lunghezzaTotale += stringa.length;
}

const lunghezzaMedia = lunghezzaTotale / ArrayStringhe.length;
